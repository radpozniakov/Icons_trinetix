  ...
  "Widgets": {
    ...
    "window": function (title,subtitle) {
      ...
      var wrapper = NSWindow.alloc().init()
        [wrapper setFrame:NSMakeRect(0, 0, 1000, 800) display:false]
      wrapper.setBackgroundColor(NSColor.whiteColor())
      wrapper.setTitle(title)

      // create a body
      body = NSView.alloc().initWithFrame(NSMakeRect(0, 0, 1000, 800))
      body.setWantsLayer(true)

      // create a main area
      main = NSView.alloc().initWithFrame(NSMakeRect(0, 0, 1000, 800))
      main.setWantsLayer(true)

      // subtitle in window
      if (subtitle!=nil) {
        subtitle = Library.Widgets.subtitle(subtitle,22,NSColor.blackColor(),NSMakeRect(25, 705, 600, 30))
    ...
    "header": function(wrapper) {
      // create a header
      header = NSView.alloc().initWithFrame(NSMakeRect(0, 735, 1000, 48))
      ...
      var exit = Library.Widgets.button(exit_icon,NSMakeRect(960, 5, 36, 36))
